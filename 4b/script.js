...
//MOCK KRAJŠI INPUT LIST (iz primera na Advent code):
/* inputList = [
`ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
byr:1937 iyr:2017 cid:147 hgt:160cm`,
...
// MOCK INVALID INPUT LIST:
/* inputList= [`eyr:1972 cid:100
...
// MOCK STRING (enega passporta)
/* let stringToSearch = `hcl:#ae17e1 iyr:2013
eyr:2024 byr:1931
...
for (passport of inputList) {   // vsak item v inputList je en passport
    ...
    try {
        ...
        passportObj = {
            ...
            eyr: parseInt(setFieldValue(passport, expirationYearRgx, 2)),
            hgt: setFieldValue(passport, heightRgx, 2),
            hcl: setFieldValue(passport, hairColorRgx,2),
...
console.log(stringToSearch.match(heightRgx))
console.log(stringToSearch.match(hairColorRgx))
console.log(stringToSearch.match(eyeColorRgx))
console.log(stringToSearch.match(passportIdRgx))
*/
